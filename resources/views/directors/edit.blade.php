@extends('layouts.app', ['activePage' => 'directors', 'titlePage' => __('Edit Director')])
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    @foreach ($director as $d)
                        <form method="post" action="{{ route('directors.update', $d->directors_id) }}" autocomplete="off"
                            ...
                            <div class="card ">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title">{{ __('Edit director') }}</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group{{ $errors->has('d_name') ? ' has-danger' : '' }}">
                                                <input
                                                    class="form-control{{ $errors->has('d_name') ? ' is-invalid' : '' }}"
                                                    name="d_name" id="input-name" type="text"
